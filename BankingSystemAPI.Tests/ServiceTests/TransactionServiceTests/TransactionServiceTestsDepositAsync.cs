...
{
    [TestFixture]
    internal class TransactionServiceTestsDepositAsync
    {
        ...
        [Test]
        public void DepositAmountAsync_WhenSuccessful()
        {
            ...
            _repository.DepositAmountAsync(Arg.Any<UserAccount>(), Arg.Any<Account>(), Arg.Any<decimal>()).Returns(responseAccount);

            //Act
            var result = _service.DepositAmountAsync(userAccount, account, amount).Result;
